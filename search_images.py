# -*- coding: utf-8 -*-
"""
Created on Thu Nov 23 20:56:30 2023
...
class ImageDownloader:
    ...
    def load_images(self):
        ...
        # Limpiar todos los widgets en el lienzo
    ...
    def clear_images(self):
        ...
        for thumbnail_label, checkbox_var, _, _ in self.images:
            ...
            checkbox_var = None  # Destruir la variable del checkbox
    ...
    def update_scrollregion(self):
        ...
        canvas_height = sum(thumbnail_label.winfo_height() for thumbnail_label, _, _, _ in self.images)
        ...
        # Configurar la barra de desplazamiento solo si hay contenido que requiere desplazamiento
        ...
        # Forzar una actualización para asegurar que la barra de desplazamiento sea visible
        self.canvas.update()
